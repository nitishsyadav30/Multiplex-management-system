...
$register_table = "create table ".$prefix."register(user-email varchar(30), user_roll int(3),pass varchar(20),fname varchar(10),lname varchar(10),gender varchar(8),city varchar(10),PRIMARY KEY(user-email))";
