...
$balconyprice=$_POST['balconyprice'];
$dcprice=$_POST['dcprice'];
$showdate = date("Y-m-d H:i:s", strtotime(str_replace('/', '-', $_POST['showdate'])));
$showid = 1;
$insert_show = "insert into ".$prefix."_add_show values('','$movie_name','$screen_select','$multiplex_name','$showdate','$time_selected','$balconyprice','$dcprice')";
